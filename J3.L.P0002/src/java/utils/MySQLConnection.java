...
public class MySQLConnection {
    ...
    public static Connection getSQLServerConnection() throws ClassNotFoundException, SQLException, NamingException {
        ...
        String uri= "jdbc:mysql://127.0.0.1:3306/P0002?useUnicode=true&useSSL=false&characterEncoding=UTF-8&zeroDateTimeBehavior=CONVERT_TO_NULL&serverTimezone=GMT";
